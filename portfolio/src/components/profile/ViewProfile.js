    ...
    <div className="card z-depth-0">
      <div className="row">
        ...
        <div className="col s12 m8">
          <h5 className="bold">
            <i className="fa title-icon fa-user" aria-hidden="true"></i>
            Name
          </h5>
          <div>
          ...
          <h5 className="bold">
            <i className="fa title-icon fa-linkedin" aria-hidden="true"></i>
            LinkedIn
          </h5>
          <div>{profile.socialUrl ? profile.socialUrl : "Empty Field"}</div>

          <h5 className="bold">
            <i className="fa title-icon fa-book" aria-hidden="true"></i>
